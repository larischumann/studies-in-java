...
public class TestaGetESet {
	...
	public static void main(String[] args) {
		...
		System.out.println(conta.getTitular()); // impressão: Cliente@15db9742
		System.out.println(conta.getTitular().getNome()); // impressão: Paulo Silveira
		...
		// Resultados iguais, pois essas variáveis e metodos são o mesmo cliente.
